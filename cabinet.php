...
<div class="doctor-name">Disponibilités du cabinet</div>
 ...
 <a href="#"> <div class="doctor-icon-container"><div class="icon-box"><i class="bi bi-geo-alt"><h6>BE</h6></div></div></i></a>
          ...
          <a href="mailto:kinostelux@gmail.com"><div class="doctor-icon-container"><div class="icon-box"><i class="bi bi-envelope"><h6>EMAIL</h6></div></div></i></a>
         <a href="tel:0035224873092"><div class="doctor-icon-container"><div class="icon-box"><i class="bi bi-telephone"><h6>TBC</h6></div></div></i></a>
</div>
</div>
...
var owner_id="612363d7592f2052d5179b4a";
</script>
</div>
