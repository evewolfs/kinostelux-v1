...
<ul class="doctor-description">
  <li><?= __('Rééducation respiratoire') ?></li>
  <li><?= __('Rééducation fonctionnelle') ?></li>
  <li><?= __('Le drainage lymphatique et cancer du sein') ?></li>
  <li><?= __('HMTC (Harmonisation tête et cou)') ?></li>
  <li><?= __(' Articulation temporo-mandibulaire') ?></li>
  <li><?= __('Trigger Point (Traitement sur des points gâchettes)') ?></li>
  <li><?= __("L'endermologie et traitements des cicatrices") ?></li>
  <li><?= __('La thérapie manuelle (Maitland)') ?></li>
  <li><?= __('Technique de Crochetage') ?></li>
  <li><?= __("L'initiation à la médecine Chinoise") ?></li>
  <li><?= __('Ventouses') ?></li>
...
<div class="doctor-spec-title"><?= __('Formation') ?></div>
    <ul class="doctor-description">
        <li><?= __('Université de Liège (2005)') ?></li>
    </ul>
