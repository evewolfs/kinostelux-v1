...
<div class="doctor-name">Malika Harboun</div>
<div class="doctor-job"><?= __('Kinésithérapeute') ?></div>
 ...
 <a href="https://goo.gl/maps/gYWE6ajmfqPt8Svv6" target="blank"><div class="doctor-icon-container"><div class="icon-box"><i class="bi bi-geo-alt"><h6><?= __('CABINET') ?></h6></div></i></a></div>
          <a href="mailto:malikamadachonkine@gmail.com"><div class="doctor-icon-container"><div class="icon-box"><i class="bi bi-envelope"><h6>EMAIL</h6></div></div></i></a>
         <a href="tel:8665562570"><div class="doctor-icon-container"><div class="icon-box"><i class="bi bi-telephone"><h6>+352 661 678 978</h6></div></div></i></a>
</div>
...
<ul class="doctor-description">
  <li><?= __('Kinésithérapie générale adultes et enfants') ?></li>
  <li><?= __('Rééducation orthopédique adultes et enfants') ?></li>
  <li><?= __('Kinésithérapie respiratoire adultes et enfants') ?></li>
  <li><?= __('Rééducation post-chirurgicale') ?></li>
  <li><?= __('Rééducation neurologique') ?></li>
  <li><?= __('Rééducation pour paralysie faciale') ?></li>
  <li><?= __('Soins à domicile dans le quartier (sous réserve de disponibilité)') ?></li>
</ul>

<div class="doctor-spec-title"><?= __('Formation') ?></div>
    <ul class="doctor-description">
        <li><?= __('Université de Liège (2007)') ?></li>
    </ul>
